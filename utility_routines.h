...
#define STS$C_WARN	"W"
#define STS$C_SUCCESS	"S"
#define STS$C_ERROR	"E"
#define STS$C_INFO	"I"
...
#define	$MSG(code)		((0x0000ffff & (code)) >> 2)
#define	$SEV(code)		((code) & 0x7)



typedef	union __emsg_sts__ {
	struct	{
#if defined(__LITTLE_ENDIAN_BITFIELD)
		unsigned char	resrvd:4;
		unsigned short	facno:12;
		unsigned short	msgno:13;
